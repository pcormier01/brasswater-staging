...
[youtube https://www.youtube.com/watch?v=AbkfQxnV4WA]
...
== Screenshots ==
1. Google Autosuggest enabled location form to add locations on map easily and quickly.
2. Assign marker categories to different locations as per requirements.
3. Easy interface to edit or remove existing locations. You can also easily search your locations. 
4. Create a marker category and assign an icon to that category.
5. Choose icon for marker category from +500 ready-made beautiful icons.
6. Easily manage and search your marker categories.
7. Easiest & minimal settings for creating a new map and getting started. Create unlimited maps.
8. Assign the created locations to the map. That's all which is required. 
9. Optionally display marker category filter, if you want your end users to be able to filter markers on map.
10. Dynamic and flexible map control settings.
11. HTML supported and dynamic placeholder supported infowindow content.
12. Manage and search maps easily.
13. Map frontend output demo one. Snazzy map style applied from back-end. Category filter enabled.
14. Map frontend output demo two. Snazzy map style applied from back-end. Category filter enabled.
15. Map frontend output demo three. Snazzy map style applied from back-end. Category filter enabled.
16. Easy to use plugin settings page to specify map language and setting up map API key for your website.
17. Quick guide with how to get started with the plugin.
18. Display the map as WordPress widget.
19. Display map in street view mode.
20. Map frontend output demo four. Snazzy map style applied from back-end.
...
Yes, You can click on [Google Maps Pro Live Demo](http://www.flippercode.com/product/wp-google-map-pro/) and mail us at hello at flippercode dot com if any pre-purchase query.
