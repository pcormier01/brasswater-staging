...
class Visual_Portfolio_Custom_Post_Type {
    ...
    public function add_role_caps() {
        ...
        $check_string = 'Plugin: 2.15.6 WP: ' . $wp_version;
    ...
    public function admin_menu() {
        ...
        add_submenu_page(
            ...
            esc_html__( 'Documentation', 'visual-portfolio' ),
            'manage_options',
            'https://visualportfolio.co/documentation/getting-started/?utm_source=plugin&utm_medium=admin_menu&utm_campaign=docs&utm_content=2.15.6'
        );
    }
                        ...
                        <td>
                            <div class="vpf-settings-info-pro">
                                ...
                                <div>
                                    ...
                                    <a class="vpf-settings-info-pro-button" target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pro/?utm_source=plugin&amp;utm_medium=settings_page&amp;utm_campaign=proofing&amp;utm_content=2.15.6">
