...
window.vc.filters = {
        ...
        void 0 === window.vc && (window.vc = {}), vc.ShortcodesBuilder = function(models) {
            ...
            save: function(status) {
                ...
                string = this.getContent(), (data = {
                    action: "vc_save"
                }).vc_post_custom_css = vc.$custom_css.val(), data.content = this.wpautop(string), status && (data.post_status = status, $(".vc_button_save_draft").hide(100) && $("#vc_button-update").text(window.i18nLocale.update_all)), vc.update_title && (data.post_title = this.getTitle()), this.ajax(data).done(function() {
    ...
    function($) {
        ...
        _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
            ...
            _this.val().length ? $target.removeAttr("disabled") : $target.prop("disabled", !0)
        })
    }(window.jQuery),
    function($) {
        "use strict";
    ...
    function($) {
        vc.cloneMethod_vc_tab = function(data, model) {
            ...
            updated: function() {
                window.InlineShortcodeView_vc_tabs.__super__.updated.call(this), this.$tabs.find(".wpb_tabs_nav:first").remove(), this.buildNav(), vc.frame_window.vc_iframe.buildTabs(this.$tabs), this.setSorting()
            },
            rowsColumnsConverted: function() {
                _.each(vc.shortcodes.where({
                    parent_id: this.model.get("id")
    ...
    }(window.jQuery), window.jQuery, window.InlineShortcodeView_vc_accordion_tab = window.InlineShortcodeView_vc_tab.extend({
    events: {
        "click > .vc_controls .vc_element .vc_control-btn-delete": "destroy",
        "click > .vc_controls .vc_element .vc_control-btn-edit": "edit",
        "click > .vc_controls .vc_element .vc_control-btn-clone": "clone",
    ...
    function($) {
        ...
        vc.createPreLoader = function() {
            ...
            if (!vc.loaded) {
                ...
                void 0 !== window.vc.undoRedoApi && _.defer(function() {
