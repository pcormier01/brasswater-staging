...
}(window.jQuery), _.isUndefined(window.vc)) vc = {
    atts: {}
};
if (function($) {
    var VcCssEditor, media = wp.media,
    ...
    media.controller.VcCssSingleImage = media.controller.VcSingleImage.extend({
        ...
        addBackgroundImage: function(e) {
            if (e.preventDefault(), window.vc_selectedFilters = {}, this.image_media) return this.image_media.open("vc_editor");
        ...
        setCurrentBgImage: function(value) {
            ...
            })) : value.match(image_regexp) && (url = (image_split = value.split(image_regexp))[1], image_split[2] && (id = image_split[2].replace(/[^\d]+/, "")), template = vc.template($("#vc_css-editor-image-block").html(), _.defaults({}, {
                variable: "img"
            }, vc.templateOptions.custom)), this.$el.find(".vc_background-image .vc_image").html(template({
                url: url,
                id: id
        ...
        getBackground: function() {
            ...
            // CSS Editor to String @UnitedThemes
            ...
            $("[data-css-editor=true]", this.content()).each(function() {
                ...
                value || (value = function() {
                    var params = vc.edit_element_block_view.model.get("params"),
                        ...
                        }, function(memo, css_name, attr_name) {
                ...
                }()), $param.data("vcFieldManager", new VcCssEditor({
                    el: $editor
                }).render(value))
...
}(window.jQuery);if (_.isUndefined(window.vc)) var vc = {
    atts: {}
};
if (function($) {
    var VcColumnOffsetParam = Backbone.View.extend({
