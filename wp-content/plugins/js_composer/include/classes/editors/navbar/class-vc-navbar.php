...
class Vc_Navbar implements Vc_Render {
	...
	public function getLogo() {
		...
		// @United
		// $output = '<a id="vc_logo" class="vc_navbar-brand" title="' . __( 'WPBakery Page Builder', 'js_composer' ) . '" href="' . esc_attr( $this->brand_url ) . '" target="_blank">' . __( 'WPBakery Page Builder', 'js_composer' ) . '</a>';
		$output = '<a id="vc_logo" class="vc_navbar-brand" title="' . __( 'Brooklyn Page Builder (Visual Composer)', 'js_composer' ) . '" href="' . esc_attr( 'http://unitedthemes.com' ) . '" target="_blank">' . __( 'Brooklyn Page Builder (Visual Composer)', 'js_composer' ) . '</a>';
