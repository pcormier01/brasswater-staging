...
?>
<div id="vc_ui-panel-preset" class="vc_ui-font-open-sans vc_ui-panel-window vc_preset-panel vc_media-xs vc_ui-panel" data-vc-panel=".vc_ui-panel-header-header" data-vc-ui-element="panel-preset" style="display: none">	<div class="vc_ui-panel-window-inner">
