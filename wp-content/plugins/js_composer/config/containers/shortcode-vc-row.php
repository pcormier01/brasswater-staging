...
return array(
	...
	'params' => array(
		...
		array(
			'type' => 'textfield',
			'heading' => __( 'Row Name', 'js_composer' ),
			'param_name' => 'el_name',
			'description' => __( 'Enter row name. This is only for internal use and adds a label to the row for a better visual perception.', 'js_composer' ),
		),
		array(
			'type' => 'checkbox',
