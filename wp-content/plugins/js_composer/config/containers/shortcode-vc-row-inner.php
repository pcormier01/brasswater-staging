...
return array(
	...
	'params' => array(
        ...
        array(
            'type' => 'checkbox',
            'heading' => __( 'Deactivate "Column" clear on Desktop?', 'js_composer' ),
            'param_name' => 'desktop_column_clear',
            'description' => __( 'If checked columns in a row will not be cleared at the end (Only Desktop).', 'js_composer' ),
            'edit_field_class'  => 'vc_col-sm-4',
            'value' => array( __( 'Yes', 'js_composer' ) => 'yes' ),
        ),
        array(
            'type' => 'checkbox',
            'heading' => __( 'Deactivate "Column" clear on Tablet?', 'js_composer' ),
            'param_name' => 'tablet_column_clear',
            'description' => __( 'If checked columns in a row will not be cleared at the end (Only Tablets).', 'js_composer' ),
            'edit_field_class'  => 'vc_col-sm-4',
            'value' => array( __( 'Yes', 'js_composer' ) => 'yes' ),
        ),
        array(
            'type' => 'checkbox',
            'heading' => __( 'Deactivate "Column" clear on Mobile?', 'js_composer' ),
            'param_name' => 'mobile_column_clear',
            'description' => __( 'If checked columns in a row will not be cleared at the end (Only Mobiles).', 'js_composer' ),
            'edit_field_class'  => 'vc_col-sm-4',
            'value' => array( __( 'Yes', 'js_composer' ) => 'yes' ),
        ),
		array(
