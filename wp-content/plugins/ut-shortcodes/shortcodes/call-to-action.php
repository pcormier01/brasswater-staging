...
if( !class_exists( 'UT_Call_To_Action' ) ) {
    ...
    class UT_Call_To_Action {
        ...
        function ut_map_shortcode() {
            ...
            vc_map(
                array(
                    ...
                    'description'     => esc_html__( 'Call to action button that grab the users attention and entice them to click.', 'ut_shortcodes' ),
                    'base'            => $this->shortcode,
                    'category'        => 'Community',
        ...
        function ut_create_shortcode( $atts, $content = NULL ) {
	        ...
	        $button_classes[]  = $button_align;
	        $button_classes[]  = 'bklyn-btn-tablet-' . $button_align_tablet;
	        $button_classes[]  = 'bklyn-btn-mobile-' . $button_align_mobile;
                ...
                $output .= '<div class="bklyn-call-to-action-inner clearfix">';
                    ...
                    if( $button_text ) {
                        ...
                        $output .= '<div class="bklyn-call-to-action-button-holder">';
                            ...
                            $output .= '<div id="' . esc_attr( $button_id ) . '" class="bklyn-btn-holder ' . implode(" ", $button_classes ) . '">';
