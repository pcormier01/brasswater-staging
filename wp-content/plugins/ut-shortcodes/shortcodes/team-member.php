    ...
    class UT_Team_Member {
        ...
        function ut_map_shortcode() {
            ...
            vc_map(
                array(
                    ...
                    'description'     => esc_html__( 'Profile your team members or employees in a creative box.', 'ut_shortcodes' ),
                    'base'            => $this->shortcode,
                    'category'        => 'Community',
                    // 'icon'            => 'fa fa-users ut-vc-module-icon',
                    ...
                    'params'          => array(
                        ...
                        array(
                            'type'          => 'range_slider',
                            'heading'       => esc_html__( 'Name Spacing Bottom', 'ut_shortcodes' ),
                            'param_name'    => 'name_spacing_bottom',
                            'group'         => 'General',
                            'value'         => array(
                                'min'   => '0',
                                'max'   => '40',
                        ...
                        array(
                            'type'          => 'range_slider',
                            'heading'       => esc_html__( 'Occupation Spacing Bottom', 'ut_shortcodes' ),
                            'param_name'    => 'occupation_spacing_bottom',
                            'group'         => 'General',
                            'value'         => array(
                                'min'   => '0',
                                'max'   => '40',
                        ...
                        array(
                            'type'              => 'range_slider',
                            'heading'           => esc_html__( 'Ocupation Letter Spacing', 'ut_shortcodes' ),
                            'param_name'        => 'ocupation_letter_spacing',
                            'group'             => 'Box Design',
                            'value'             => array(
                                'default'   => '0',
                                'min'       => '-0.2',
                        ...
                        array(
                            ...
                            'dependency' => array(
                                'element' => 'style',
                                'value'   => array( 'member-style-1', 'member-style-2', 'member-style-3', 'member-style-4', 'member-style-5' ),
                            ),
                        ),
        ...
        function ut_create_shortcode( $atts, $content = NULL ) {
            ...
            extract( shortcode_atts( array (
                ...
                'ocupation_letter_spacing'  => '',
                'occupation_spacing_bottom' => '',
                'description_color'     => '',
                'social'                => '',
                'icon_size'             => '',
                'icon_color'            => '',
            ...
            if( $style == 'member-style-2' ) {
            	...
            	$width = $height = $avatar_size * 2;

                $avatar = ut_resize( wp_get_attachment_url( $avatar ) , $width, $height, true, true, true );
                $avatar_alternate = ut_resize( wp_get_attachment_url( $avatar_alternate ) , $width, $height, true, true, true );
	            ...
	            $avatar = ut_resize( wp_get_attachment_url( $avatar ) , $width, $height, true, true, false );
				$final_sizes  = UT_Adaptive_Image::get_generated_image_size( $avatar );

	            $width  = $final_sizes[0];
	            $height = $final_sizes[1];

                $avatar_alternate = ut_resize( wp_get_attachment_url( $avatar_alternate ) , $width, $height, true, true, false );
            ...
            $css_style = '<style type="text/css">';
                ...
                if( $name_spacing_bottom ) {
                    $css_style .= '#' . $id . ' .bklyn-team-member-name { margin-bottom: ' . $name_spacing_bottom . 'px; }';
                }            
                ...
                if( $icon_size && ( $style == 'member-style-2' || $style == 'member-style-1' || $style == 'member-style-5' || $style == 'member-style-3' || $style == 'member-style-4' ) ) {
                ...
                if( $ocupation_letter_spacing ) {
                    $css_style .= '#' . $id . ' .bklyn-team-member-ocupation { letter-spacing: ' . $ocupation_letter_spacing . 'em; }';                     
                }
            
                if( $occupation_spacing_bottom ) {
                    $css_style .= '#' . $id . ' .bklyn-team-member-ocupation { margin-bottom: ' . $occupation_spacing_bottom . 'px; }';
                }            
                ...
                if( !empty( $avatar ) ) {
                    ...
                    $this->output .= '<div class="bklyn-team-member-avatar ' . ( ( $swap_avatar == 'on' ) ? 'bklyn-team-member-avatar-with-swap' : '' ) . '">';
                        ...
                        if( $swap_avatar == 'on' ) {
                            ...
                            $this->output .= '<div class="bklyn-team-member-primary-image"><img alt="' . esc_attr( $alt ) . '" class="ut-lozad" src="' . $this->create_placeholder_svg( $width, $height ) . '" data-src="' . esc_url( $avatar ) .  '"></div>';
                            $this->output .= '<div class="bklyn-team-member-secondary-image"><img alt="' . esc_attr( $alt ) . '" class="ut-lozad" src="' . $this->create_placeholder_svg( $width, $height ) . '" data-src="' . esc_url( $avatar_alternate ) .  '"></div>';
                        
                        } else {

                            $this->output .= '<img alt="' . esc_attr( $alt ) . '" class="ut-lozad" src="' . $this->create_placeholder_svg( $width, $height ) . '" data-src="' . esc_url( $avatar ) .  '">';
