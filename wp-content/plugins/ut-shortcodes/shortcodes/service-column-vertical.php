            ...
            $output .= '<div id="' . $id . '" class="' . implode(' ', $classes ) . ' ut-vertical-style ut-vertical-style-align-' . $align . '" ' . $margin_bottom . '>';
                ...
                if( $image_icon ) {
                    ...
                    $output .= '<figure ' . $attributes . ' class="ut-service-icon ut-custom-icon ' . implode(' ', $classes_2 ) . '">';                        
                        ...
                        // $output .= '<img alt="' . ( !empty( $headline ) ? esc_attr( $headline ) : 'icon' ) . '" class="ut-lozad" data-src="' . esc_url( $icon ) . '">';
                ...
                $output .= '<div class="ut-service-column ut-vertical">';
                    ...
                    if( !empty( $headline ) ) {
                        ...
                        $output .= '<'. $headline_tag .' ' . $responsive_font_attributes . ' class="ut-service-column-title element-with-custom-line-height">' . $headline . '</'. $headline_tag .'>';
