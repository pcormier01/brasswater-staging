    ...
    class UT_Person_Module {
            ...
            vc_map(
                array(
                    ...
                    'params'          => array(
	                    ...
	                    array(
		                    'type'              => 'dropdown',
		                    'heading'           => esc_html__( 'Display Avatar in Portrait Format?', 'ut_shortcodes' ),
		                    'param_name'        => 'portrait',
		                    'group'             => 'General',
		                    'value'             => array(
        ...
        function ut_create_shortcode( $atts, $content = NULL ) {
	        ...
	        if( $style == 'member-style-2' ) {
		        ...
		        if( class_exists('UT_Adaptive_Image') ) {
			        ...
			        if( $portrait == 'on' ) {
				        ...
				        $avatar = UT_Adaptive_Image::create( $avatar, array( '1080', '1350' ), true, 'portrait' );

			        } else {

				        $avatar = UT_Adaptive_Image::create( $avatar, array( get_option('large_size_w'), get_option('large_size_h') ), true, 'landscape' );
            ...
            if( $ocupation_letter_spacing ) {
                $css_style .= '#' . $id . ' .bklyn5-team-member-ocupation { letter-spacing: ' . $ocupation_letter_spacing . 'em; }'; 
            }
			...
			if( $icon_size ) {
				$css_style .= '#' . $id . ' .bklyn5-team-member-social-icons a { font-size: ' . $icon_size . 'px; }';
			}
            ...
            if( $overlay_color && ut_is_gradient( $overlay_color ) ) {
                
				$css_style .= ut_create_gradient_css( $overlay_color, '#' . esc_attr( $id ) . ' .bklyn5-team-member-overlay', false, 'background' );
            ...
            if( !empty( $css_style ) ) {
                $this->output .= ut_minify_inline_css( '<style type="text/css">' . $css_style . '</style>' );
            }
            ...
            $this->output .= '<div id="' . esc_attr( $id ) . '" class="bklyn5-team-member bklyn5-team-' . esc_attr( $style ) . ' bklyn5-team-member-' . $align . '">';
                ...
                if( !empty( $avatar ) ) {
	                ...
	                if ( $style == 'member-style-2' ) {
		                ...
		                $this->output .= '<img alt="' . esc_attr( $this->name ) . '" src="' . esc_url( $avatar ) . '">';
